...
describe('Brand CRUD tests', function () {
      ...
      .end(function (signinErr, signinRes) {
        ...
        agent.post('/api/brands-uk')
          ...
          .end(function (brandSaveErr, brandSaveRes) {
            ...
            agent.put('/api/brands-uk/' + brandSaveRes.body._id)
              .send(brand)
              .expect(200)
  ...
  it('should be able to get a single Brand if not signed in', function (done) {
    ...
    // Save the Brand
    brandObj.save(function () {
      request(app).get('/api/brands-uk/' + brandObj._id)
        .end(function (req, res) {
          // Set assertion
  ...
  it('should return proper error for single Brand with an invalid Id, if not signed in', function (done) {
    ...
    request(app).get('/api/brands-uk/test')
      .end(function (req, res) {
        // Set assertion
  ...
  it('suhould retrn proper error for single Brand which doesnt exist, if not signed in', function (done) {
    // This is a valid mongoose Id but a non-existent Brand
    request(app).get('/api/brands-uk/559e9cd815f80b4c256a8f41')
      .end(function (req, res) {
        // Set assertion
        res.body.should.be.instanceof(Object).and.have.property('message', '22No Brand with that identifier has been found');
      ...
      .end(function (signinErr, signinRes) {
        ...
        agent.post('/api/brands-uk')
          ...
          .end(function (brandSaveErr, brandSaveRes) {
            ...
            agent.delete('/api/brands-uk/' + brandSaveRes.body._id)
              .send(brand)
              .expect(200)
  ...
  it('should not be able to delete an Brand if not signed in', function (done) {
    ...
    brandObj.save(function () {
      // Try deleting Brand
      request(app).delete('/api/brands-uk/' + brandObj._id)
        .expect(403)
        .end(function (brandDeleteErr, brandDeleteRes) {
          // Set message assertion
              ...
              orphan.remove(function () {
                ...
                agent.post('/api/auth/signin')
                  ...
                  .end(function (err, res) {
                    ...
                    // Get the Brand
                    agent.get('/api/brands-uk/' + brandSaveRes.body._id)
                      .expect(200)
