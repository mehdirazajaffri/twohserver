...
!function(app){"use strict";app.registerModule("advertises")}(ApplicationConfiguration);
...
!function(app){"use strict";app.registerModule("brands")}(ApplicationConfiguration);
...
!function(app){"use strict";app.registerModule("items")}(ApplicationConfiguration);
...
!function(){"use strict";function menuConfig(menuService){menuService.addMenuItem("topbar",{title:"Advertises",state:"advertises",type:"dropdown",roles:["*"]}),menuService.addSubMenuItem("topbar","advertises",{title:"List Advertises",state:"advertises.list"}),menuService.addSubMenuItem("topbar","advertises",{title:"Create Advertise",state:"advertises.create",roles:["user"]})}angular.module("advertises").run(menuConfig),menuConfig.$inject=["menuService"]}();
!function(){"use strict";function routeConfig($stateProvider){$stateProvider.state("advertises",{abstract:!0,url:"/advertises",template:"<ui-view/>"}).state("advertises.list",{url:"",templateUrl:"modules/advertises/client/views/list-advertises.client.view.html",controller:"AdvertisesListController",controllerAs:"vm",data:{pageTitle:"Advertises List"}}).state("advertises.create",{url:"/create",templateUrl:"modules/advertises/client/views/form-advertise.client.view.html",controller:"AdvertisesController",controllerAs:"vm",resolve:{advertiseResolve:newAdvertise},data:{roles:["user","admin"],pageTitle:"Advertises Create"}}).state("advertises.edit",{url:"/:advertiseId/edit",templateUrl:"modules/advertises/client/views/form-advertise.client.view.html",controller:"AdvertisesController",controllerAs:"vm",resolve:{advertiseResolve:getAdvertise},data:{roles:["user","admin"],pageTitle:"Edit Advertise {{ advertiseResolve.name }}"}}).state("advertises.view",{url:"/:advertiseId",templateUrl:"modules/advertises/client/views/view-advertise.client.view.html",controller:"AdvertisesController",controllerAs:"vm",resolve:{advertiseResolve:getAdvertise},data:{pageTitle:"Advertise {{ advertiseResolve.name }}"}})}function getAdvertise($stateParams,AdvertisesService){return AdvertisesService.get({advertiseId:$stateParams.advertiseId}).$promise}function newAdvertise(AdvertisesService){return new AdvertisesService}angular.module("advertises").config(routeConfig),routeConfig.$inject=["$stateProvider"],getAdvertise.$inject=["$stateParams","AdvertisesService"],newAdvertise.$inject=["AdvertisesService"]}();
!function(){"use strict";function AdvertisesController($scope,$state,$window,Authentication,advertise){function remove(){$window.confirm("Are you sure you want to delete?")&&vm.advertise.$remove($state.go("advertises.list"))}function save(isValid){function successCallback(res){$state.go("advertises.view",{advertiseId:res._id})}function errorCallback(res){vm.error=res.data.message}return isValid?void(vm.advertise._id?vm.advertise.$update(successCallback,errorCallback):vm.advertise.$save(successCallback,errorCallback)):($scope.$broadcast("show-errors-check-validity","vm.form.advertiseForm"),!1)}var vm=this;vm.authentication=Authentication,vm.advertise=advertise,vm.error=null,vm.form={},vm.remove=remove,vm.save=save}angular.module("advertises").controller("AdvertisesController",AdvertisesController),AdvertisesController.$inject=["$scope","$state","$window","Authentication","advertiseResolve"]}();
!function(){"use strict";function AdvertisesListController(AdvertisesService){var vm=this;vm.advertises=AdvertisesService.query()}angular.module("advertises").controller("AdvertisesListController",AdvertisesListController),AdvertisesListController.$inject=["AdvertisesService"]}();
!function(){"use strict";function AdvertisesService($resource){return $resource("api/advertises/:advertiseId",{advertiseId:"@_id"},{update:{method:"PUT"}})}angular.module("advertises").factory("AdvertisesService",AdvertisesService),AdvertisesService.$inject=["$resource"]}();
...
!function(){"use strict";function menuConfig(menuService){menuService.addMenuItem("topbar",{title:"Brands",state:"brands",type:"dropdown",roles:["*"]}),menuService.addSubMenuItem("topbar","brands",{title:"List Brands",state:"brands.list"}),menuService.addSubMenuItem("topbar","brands",{title:"Create Brand",state:"brands.create",roles:["user"]})}angular.module("brands").run(menuConfig),menuConfig.$inject=["menuService"]}();
!function(){"use strict";function routeConfig($stateProvider){$stateProvider.state("brands",{abstract:!0,url:"/brands",template:"<ui-view/>"}).state("brands.list",{url:"",templateUrl:"modules/brands/client/views/list-brands.client.view.html",controller:"BrandsListController",controllerAs:"vm",data:{pageTitle:"Brands List"}}).state("brands.create",{url:"/create",templateUrl:"modules/brands/client/views/form-brand.client.view.html",controller:"BrandsController",controllerAs:"vm",resolve:{brandResolve:newBrand},data:{roles:["user","admin"],pageTitle:"Brands Create"}}).state("brands.edit",{url:"/:brandId/edit",templateUrl:"modules/brands/client/views/form-brand.client.view.html",controller:"BrandsController",controllerAs:"vm",resolve:{brandResolve:getBrand},data:{roles:["user","admin"],pageTitle:"Edit Brand {{ brandResolve.name }}"}}).state("brands.view",{url:"/:brandId",templateUrl:"modules/brands/client/views/view-brand.client.view.html",controller:"BrandsController",controllerAs:"vm",resolve:{brandResolve:getBrand},data:{pageTitle:"Brand {{ brandResolve.name }}"}})}function getBrand($stateParams,BrandsService){return BrandsService.get({brandId:$stateParams.brandId}).$promise}function newBrand(BrandsService){return new BrandsService}angular.module("brands").config(routeConfig),routeConfig.$inject=["$stateProvider"],getBrand.$inject=["$stateParams","BrandsService"],newBrand.$inject=["BrandsService"]}();
!function(){"use strict";function BrandsController($scope,$state,$window,Authentication,brand){function remove(){$window.confirm("Are you sure you want to delete?")&&vm.brand.$remove($state.go("brands.list"))}function save(isValid){function successCallback(res){$state.go("brands.view",{brandId:res._id})}function errorCallback(res){vm.error=res.data.message}return isValid?void(vm.brand._id?vm.brand.$update(successCallback,errorCallback):vm.brand.$save(successCallback,errorCallback)):($scope.$broadcast("show-errors-check-validity","vm.form.brandForm"),!1)}var vm=this;vm.authentication=Authentication,vm.brand=brand,vm.error=null,vm.form={},vm.remove=remove,vm.save=save}angular.module("brands").controller("BrandsController",BrandsController),BrandsController.$inject=["$scope","$state","$window","Authentication","brandResolve"]}();
!function(){"use strict";function BrandsListController(BrandsService){var vm=this;vm.brands=BrandsService.query()}angular.module("brands").controller("BrandsListController",BrandsListController),BrandsListController.$inject=["BrandsService"]}();
!function(){"use strict";function BrandsService($resource){return $resource("api/brands/:brandId",{brandId:"@_id"},{update:{method:"PUT"}})}angular.module("brands").factory("BrandsService",BrandsService),BrandsService.$inject=["$resource"]}();
!function(){"use strict";function menuConfig(menuService){menuService.addMenuItem("topbar",{title:"Categories",state:"categories",type:"dropdown",roles:["*"]}),menuService.addSubMenuItem("topbar","categories",{title:"List Categories",state:"categories.list"}),menuService.addSubMenuItem("topbar","categories",{title:"Create Category",state:"categories.create",roles:["user"]})}angular.module("categories").run(menuConfig),menuConfig.$inject=["menuService"]}();
!function(){"use strict";function routeConfig($stateProvider){$stateProvider.state("categories",{abstract:!0,url:"/categories",template:"<ui-view/>"}).state("categories.list",{url:"",templateUrl:"modules/categories/client/views/list-categories.client.view.html",controller:"CategoriesListController",controllerAs:"vm",data:{pageTitle:"Categories List"}}).state("categories.create",{url:"/create",templateUrl:"modules/categories/client/views/form-category.client.view.html",controller:"CategoriesController",controllerAs:"vm",resolve:{categoryResolve:newCategory},data:{roles:["user","admin"],pageTitle:"Categories Create"}}).state("categories.edit",{url:"/:categoryId/edit",templateUrl:"modules/categories/client/views/form-category.client.view.html",controller:"CategoriesController",controllerAs:"vm",resolve:{categoryResolve:getCategory},data:{roles:["user","admin"],pageTitle:"Edit Category {{ categoryResolve.name }}"}}).state("categories.view",{url:"/:categoryId",templateUrl:"modules/categories/client/views/view-category.client.view.html",controller:"CategoriesController",controllerAs:"vm",resolve:{categoryResolve:getCategory},data:{pageTitle:"Category {{ categoryResolve.name }}"}})}function getCategory($stateParams,CategoriesService){return CategoriesService.get({categoryId:$stateParams.categoryId}).$promise}function newCategory(CategoriesService){return new CategoriesService}angular.module("categories").config(routeConfig),routeConfig.$inject=["$stateProvider"],getCategory.$inject=["$stateParams","CategoriesService"],newCategory.$inject=["CategoriesService"]}();
!function(){"use strict";function CategoriesController($scope,$state,$window,Authentication,category){function remove(){$window.confirm("Are you sure you want to delete?")&&vm.category.$remove($state.go("categories.list"))}function save(isValid){function successCallback(res){$state.go("categories.view",{categoryId:res._id})}function errorCallback(res){vm.error=res.data.message}return isValid?void(vm.category._id?vm.category.$update(successCallback,errorCallback):vm.category.$save(successCallback,errorCallback)):($scope.$broadcast("show-errors-check-validity","vm.form.categoryForm"),!1)}var vm=this;vm.authentication=Authentication,vm.category=category,vm.error=null,vm.form={},vm.remove=remove,vm.save=save}angular.module("categories").controller("CategoriesController",CategoriesController),CategoriesController.$inject=["$scope","$state","$window","Authentication","categoryResolve"]}();
!function(){"use strict";function CategoriesListController(CategoriesService){var vm=this;vm.categories=CategoriesService.query()}angular.module("categories").controller("CategoriesListController",CategoriesListController),CategoriesListController.$inject=["CategoriesService"]}();
!function(){"use strict";function CategoriesService($resource){return $resource("api/categories/:categoryId",{categoryId:"@_id"},{update:{method:"PUT"}})}angular.module("categories").factory("CategoriesService",CategoriesService),CategoriesService.$inject=["$resource"]}();
...
!function(){"use strict";function menuConfig(menuService){menuService.addMenuItem("topbar",{title:"Items",state:"items",type:"dropdown",roles:["*"]}),menuService.addSubMenuItem("topbar","items",{title:"List Items",state:"items.list"}),menuService.addSubMenuItem("topbar","items",{title:"Create Item",state:"items.create",roles:["user"]})}angular.module("items").run(menuConfig),menuConfig.$inject=["menuService"]}();
!function(){"use strict";function routeConfig($stateProvider){$stateProvider.state("items",{abstract:!0,url:"/items",template:"<ui-view/>"}).state("items.list",{url:"",templateUrl:"modules/items/client/views/list-items.client.view.html",controller:"ItemsListController",controllerAs:"vm",data:{pageTitle:"Items List"}}).state("items.create",{url:"/create",templateUrl:"modules/items/client/views/form-item.client.view.html",controller:"ItemsController",controllerAs:"vm",resolve:{itemResolve:newItem},data:{roles:["user","admin"],pageTitle:"Items Create"}}).state("items.edit",{url:"/:itemId/edit",templateUrl:"modules/items/client/views/form-item.client.view.html",controller:"ItemsController",controllerAs:"vm",resolve:{itemResolve:getItem},data:{roles:["user","admin"],pageTitle:"Edit Item {{ itemResolve.name }}"}}).state("items.view",{url:"/:itemId",templateUrl:"modules/items/client/views/view-item.client.view.html",controller:"ItemsController",controllerAs:"vm",resolve:{itemResolve:getItem},data:{pageTitle:"Item {{ itemResolve.name }}"}})}function getItem($stateParams,ItemsService){return ItemsService.get({itemId:$stateParams.itemId}).$promise}function newItem(ItemsService){return new ItemsService}angular.module("items").config(routeConfig),routeConfig.$inject=["$stateProvider"],getItem.$inject=["$stateParams","ItemsService"],newItem.$inject=["ItemsService"]}();
!function(){"use strict";function ItemsController($scope,$state,$window,Authentication,item){function remove(){$window.confirm("Are you sure you want to delete?")&&vm.item.$remove($state.go("items.list"))}function save(isValid){function successCallback(res){$state.go("items.view",{itemId:res._id})}function errorCallback(res){vm.error=res.data.message}return isValid?void(vm.item._id?vm.item.$update(successCallback,errorCallback):vm.item.$save(successCallback,errorCallback)):($scope.$broadcast("show-errors-check-validity","vm.form.itemForm"),!1)}var vm=this;vm.authentication=Authentication,vm.item=item,vm.error=null,vm.form={},vm.remove=remove,vm.save=save}angular.module("items").controller("ItemsController",ItemsController),ItemsController.$inject=["$scope","$state","$window","Authentication","itemResolve"]}();
!function(){"use strict";function ItemsListController(ItemsService){var vm=this;vm.items=ItemsService.query()}angular.module("items").controller("ItemsListController",ItemsListController),ItemsListController.$inject=["ItemsService"]}();
!function(){"use strict";function ItemsService($resource){return $resource("api/items/:itemId",{itemId:"@_id"},{update:{method:"PUT"}})}angular.module("items").factory("ItemsService",ItemsService),ItemsService.$inject=["$resource"]}();
!function(){"use strict";function menuConfig(menuService){menuService.addMenuItem("topbar",{title:"Orders",state:"orders",type:"dropdown",roles:["*"]}),menuService.addSubMenuItem("topbar","orders",{title:"List Orders",state:"orders.list"}),menuService.addSubMenuItem("topbar","orders",{title:"Create Order",state:"orders.create",roles:["user"]})}angular.module("orders").run(menuConfig),menuConfig.$inject=["menuService"]}();
...
!function(){"use strict";function OrdersListController(OrdersService){var vm=this;vm.orders=OrdersService.query()}angular.module("orders").controller("OrdersListController",OrdersListController),OrdersListController.$inject=["OrdersService"]}();
!function(){"use strict";function OrdersController($scope,$state,$window,Authentication,order){function remove(){$window.confirm("Are you sure you want to delete?")&&vm.order.$remove($state.go("orders.list"))}function save(isValid){function successCallback(res){$state.go("orders.view",{orderId:res._id})}function errorCallback(res){vm.error=res.data.message}return isValid?void(vm.order._id?vm.order.$update(successCallback,errorCallback):vm.order.$save(successCallback,errorCallback)):($scope.$broadcast("show-errors-check-validity","vm.form.orderForm"),!1)}var vm=this;vm.authentication=Authentication,vm.order=order,vm.error=null,vm.form={},vm.remove=remove,vm.save=save}angular.module("orders").controller("OrdersController",OrdersController),OrdersController.$inject=["$scope","$state","$window","Authentication","orderResolve"]}();
